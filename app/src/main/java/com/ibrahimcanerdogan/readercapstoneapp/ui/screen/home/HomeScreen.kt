...
import com.ibrahimcanerdogan.readercapstoneapp.ui.component.ListCard
import com.ibrahimcanerdogan.readercapstoneapp.ui.component.ReaderAppBar
import com.ibrahimcanerdogan.readercapstoneapp.ui.component.TitleSection
import com.ibrahimcanerdogan.readercapstoneapp.ui.navigation.AppScreen
import com.ibrahimcanerdogan.readercapstoneapp.ui.widget.FABContent
...
fun HomeContent(navController: NavController, viewModel: HomeViewModel) {
    ...
    if (!viewModel.data.value.stateData.isNullOrEmpty()) {
        listOfBooks = viewModel.data.value.stateData!!.toList().filter { mBook ->
        ...
        Row(modifier = Modifier.align(alignment = Alignment.Start)) {
            ...
            Column {
                Icon(
                    ...
                    modifier = Modifier
                        .clickable {
                            navController.navigate(AppScreen.ReaderStatsScreen.name)
                        }
                        .size(45.dp),
...
fun BookListArea(listOfBooks: List<MBook>,
    ...
    HorizontalScrollableComponent(addedBooks){
        navController.navigate(AppScreen.UpdateScreen.name +"/$it")
...
fun HorizontalScrollableComponent(listOfBooks: List<MBook>,
    ...
    Row(modifier = Modifier
        ...
        if (viewModel.data.value.stateLoading == true) {
