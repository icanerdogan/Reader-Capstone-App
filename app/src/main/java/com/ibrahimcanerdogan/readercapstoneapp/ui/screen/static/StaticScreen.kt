package com.ibrahimcanerdogan.readercapstoneapp.ui.screen.static
...
@Composable
fun StaticScreen(navController: NavController,
    ...
    Scaffold(
        ...
        Surface(modifier = Modifier.padding(contentPadding)) {
            ...
            books = if (!viewModel.data.value.stateData.isNullOrEmpty()) {
                viewModel.data.value.stateData!!.filter { mBook ->
            ...
            Column {
                ...
                Card(modifier = Modifier
                    ...
                    val readBooksList: List<MBook> = if (!viewModel.data.value.stateData.isNullOrEmpty()) {
                        books.filter { mBook ->
                ...
                if (viewModel.data.value.stateLoading == true) {
                    ...
                    LazyColumn(modifier = Modifier
                        ...
                        val readBooks: List<MBook> = if (!viewModel.data.value.stateData.isNullOrEmpty()){
                            viewModel.data.value.stateData!!.filter { mBook ->
                                (mBook.userId == currentUser?.uid) && (mBook.finishedReading != null)
                            }
                        }else {
